...
class Barang_p extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templatep','barang_list_p', $data);
    }
    ...
    public function read($id) 
    {
		...
		'TanggalMasuk' => $row->TanggalMasuk,
            ...
            $this->template->load('templatep','barang_read_p', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('barang_p'));
        }
    }
    ...
    public function create() 
    {
        ...
        $data = array(
            'button' => 'Create',
            'action' => site_url('barang_p/create_action'),
        ...
        $this->template->load('templatep','barang_form_p', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('Barang_p/update_action'),
    ...
    public function move($id) 
    {
        ...
        if ($row) {
            $data = array(
                 'button' => 'Mutasi',
                 'action' => site_url('Barang_p/move_action'),
        'IdBarang' => set_value('IdBarang', $row->IdBarang),
        'NamaBarang' => set_value('NamaBarang', $row->NamaBarang),
        'Stok' => set_value('Stok', $row->Stok),
        'KetTempat' => set_value('KetTempat', $row->KetTempat),
