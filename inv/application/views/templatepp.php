        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>Sisfo Inventaris</b></span>
                </a>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<?php echo base_url()?>template/dist/img/widodo.png" class="img-circle" alt="User Image">
                        </div>
...
<!--                                <small class="label pull-right bg-red">3</small>-->
                        ...
                        <?php
                        $menu3 = $this->db->get_where('menu3', array('is_parent' => 0,'is_active'=>1));
                        foreach ($menu3->result() as $m) {
                            // chek ada sub menu
                            $submenu = $this->db->get_where('menu3',array('is_parent'=>$m->id,'is_active'=>1));
